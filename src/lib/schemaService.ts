    ...
    const knownSchemas: Record<string, TableSchema> = {
      sales_log: {
        ...
        columns: [
          ...
          { column_name: 'p_grams', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 10, numeric_scale: 3 },
          { column_name: 'p_purity', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 5, numeric_scale: 2 },
          { column_name: 'p_cost', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 12, numeric_scale: 2 },
          { column_name: 's_purity', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 5, numeric_scale: 2 },
          ...
          { column_name: 's_cost', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 12, numeric_scale: 2 },
          { column_name: 'o1_gram', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 10, numeric_scale: 3 },
          { column_name: 'o1_purity', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 5, numeric_scale: 2 },
          ...
          { column_name: 'o2_purity', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 5, numeric_scale: 2 },
          { column_name: 'o_cost', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 12, numeric_scale: 2 },
      ...
      expense_log: {
        ...
        columns: [
          ...
          { column_name: 'udhaar', data_type: 'boolean', is_nullable: 'YES', column_default: 'false', character_maximum_length: null, numeric_precision: null, numeric_scale: null },
          { column_name: 'created_at', data_type: 'timestamp with time zone', is_nullable: 'YES', column_default: 'now()', character_maximum_length: null, numeric_precision: null, numeric_scale: null },
        ],
        primaryKeys: ['id'],
        foreignKeys: [],
      ...
      daily_rates: {
        ...
        columns: [
          ...
          { column_name: 'n_price', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 12, numeric_scale: 2 },
          { column_name: 'o_price', data_type: 'numeric', is_nullable: 'YES', column_default: null, character_maximum_length: null, numeric_precision: 12, numeric_scale: 2 },
          { column_name: 'created_at', data_type: 'timestamp with time zone', is_nullable: 'YES', column_default: 'now()', character_maximum_length: null, numeric_precision: null, numeric_scale: null },
        ],
        primaryKeys: ['id'],
        foreignKeys: [],
